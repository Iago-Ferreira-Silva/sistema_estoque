...
INSERT INTO produtos (nome, categoria, unidade, unidade_minima, fator_conversao, qtd_atual, qtd_minima) VALUES
  -- 1 pacote = 500 folhas | 2 pct = 1000 folhas | mínimo: 10 pct = 5000 folhas
  ('Papel A4',         'escritorio', 'pct', 'folha',     500,  1000,  5000),

  -- 1 unidade = 1 unidade (sem conversão)
  ('Detergente 500ml', 'limpeza',    'un',  'unidade',   1,    5,     8),

  -- 1 caixa = 12 unidades | 1 cx = 12 un | mínimo: 5 cx = 60 un
  ('Caneta Azul',      'escritorio', 'cx',  'unidade',   12,   12,    60),

  -- 1 litro = 1000 mililitros | 20 lt = 20000 ml | mínimo: 5 lt = 5000 ml
  ('Álcool 70%',       'limpeza',    'lt',  'mililitro', 1000, 20000, 5000),

  -- 1 pacote = 2 rolos | 15 pct = 30 rolos | mínimo: 10 pct = 20 rolos
...
INSERT INTO movimentacoes
  (produto_id, setor_id, usuario_id, responsavel_nome, tipo, quantidade, unidade_mov, quantidade_convertida, observacao)
VALUES
  -- Álcool 70%: entrada de 10 litros = 10000 ml
  (4, 3, 1, 'Carlos Lima',  'entrada', 10, 'litro',   10000, 'Reposição mensal'),

  -- Papel A4: saída de 3 pacotes = 1500 folhas
  (1, 1, 2, 'Maria Silva',  'saida',   3,  'pacote',  1500,  NULL),

  -- Caneta Azul: saída de 5 caixas = 60 unidades
  (3, 2, 3, 'João Mendes',  'saida',   5,  'caixa',   60,    'Uso em reunião'),

  -- Detergente: entrada de 6 unidades
  (2, 3, 4, 'Carlos Lima',  'entrada', 6,  'unidade', 6,     NULL),

  -- Papel Toalha: saída de 2 pacotes = 4 rolos
  (5, 4, 4, 'Ana Souza',    'saida',   2,  'pacote',  4,     NULL);
